...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
      <main className="lg:grid grid-cols-3 gap-0 h-[100vh] bg-black ,ax-w-[100vw] overflow-hidden" style={{ gridTemplateColumns: '25% 50% 25%' }}>
        
        <RespContainer class_full="" hide={true} class_sm="bg-black" >
          <Sidebar />
        </RespContainer>
  
        <RespContainer id="current-page" hide={false} class_full="flex flex-col min-w-full justify-between h-[100%] bg-black " class_sm="  w-full pb-5 mb-20 bg-black">
          <div
            id="layout-wrapper"
        ...
        <RespContainer hide={false} class_full="display-none" class_sm="">
